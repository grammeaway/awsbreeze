...
## Config 
awsbreeze stores its config and recently-read articles, in a file called `.awsbreeze.json` in the user's home directory. The config file is automatically created when you run the program for the first time.
